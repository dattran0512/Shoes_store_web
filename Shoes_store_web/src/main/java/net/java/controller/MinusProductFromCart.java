...
/**
 * Servlet implementation class MinusProductFromCart
 */
@WebServlet("/MinusProductFromCart")
public class MinusProductFromCart extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MinusProductFromCart() {
        super();
