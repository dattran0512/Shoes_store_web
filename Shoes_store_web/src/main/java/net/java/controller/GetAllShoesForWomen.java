...
/**
 * Servlet implementation class GetAllShoesForWomen
 */
@WebServlet("/GetAllShoesForWomen")
public class GetAllShoesForWomen extends HttpServlet {
	private static final long serialVersionUID = 1L;
	ShoesDAO shoesDAO = new ShoesDAO();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetAllShoesForWomen() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Shoes> listWomenShoes = shoesDAO.getAll_WomenShoes();
		request.setAttribute("listShoes" , listWomenShoes);
